...
app = Flask(__name__)
app.secret_key="1"
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=824dfd4d-99de-440d-999-629c01b3832d.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=30119;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=nyb16417;PWD=BdnbqnFcLHDyszAv",'','')
@app.route("/")
def index():
